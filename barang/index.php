...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search" method="post" action="barang_search.php">
        <input class="form-control me-2" type="search" name="nama_barang" placeholder="Search Nama Barang" aria-label="Search">
        <button class="btn btn-outline-success" type="submit">Search</button>
      </form>
    </div>
  </div>
</nav>
<!-- Menu awal dan untuk menampilkan data -->
<h1 h1 style="text-align:center">Data Barang</h1>
<div class="container">
<a href="barang_formadd.php" type="button" class="btn btn-primary" style="margin-bottom: 10px">INPUT </a>
...
<table class="table" style="border: 1px solid black; border-collapse: collapse">
  ...
  <tbody>
  <?php 
        $sqlbarang = "SELECT * FROM tb_barang ORDER BY id ASC";
